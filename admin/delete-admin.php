...
<html>
    ...
    <title>Admin@Youslay | Delete Admin</title>
...
<header class="fs-1 fw-light text-center m-5 p-5">
    Do You Want To Delete Admin?</header>
    <form action="" method="POST" class="d-grid gap-2 col-6 mx-auto">
    
        <a href="manage-admin.php" class="d-grid gap-2 col-6 mx-auto text-decoration-none">
...
if(isset($_POST['y']))
       {
         ...
         if($res==true)
         {
          $_SESSION['add'] ="<div class='alert alert-danger'>SUCCESSFULLY DELETED ADMIN!!</div>";
